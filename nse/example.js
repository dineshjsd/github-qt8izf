...
function getMarketStatus() {
  return API.getMarketStatus().then(function (value) {
 ...
 */
function getIndices() {
  return API.getIndices().then(function (value) {
    console.log(value.data);
  });
}
...
function getSectorsList() {
  return API.getSectorsList().then(function (value) {
    console.log(value.data);
  });
}

function getQuotes(symbol) {
  return API.getQuotes().then(function (value) {
    console.log(value.data);
  });
}
...
function getQuoteInfo(symbol) {
  return API.getQuoteInfo(symbol).then(function (value) {
    console.log(value.data);
  });
}
 ...
 */
function getGainers() {
  return API.getGainers().then(function (value) {
    console.log(value.data);
  });
}
 ...
 */
function getLosers() {
  return API.getLosers().then(function (value) {
    console.log(value.data);
  });
}
...
function getInclineDecline() {
  return API.getInclineDecline().then(function (value) {
    console.log(value.data);
  });
}

function getIndexStocks(slugs) {
  return API.getIndexStocks(slugs).then(function (value) {
    console.log(value.data);
  });
}

function getIntraDayData(symbol, time) {
  return API.getIntraDayData(symbol, time).then(function (value) {
    console.log(value.data, 'value');
  });
}

function searchStocks(symbol) {
  return API.searchStocks(symbol).then(function (value) {
    var data = value.data;
    console.log(data);
  });
}
...
function getStockFuturesData(symbol, date) {
  return API.getStockFuturesData(symbol, date).then(function (value) {
    var data = value.data;
    console.log(data);
  });
}
...
function get52WeekHigh() {
  return API.get52WeekHigh().then(function (value) {
    var data = value.data;
    console.log(data);
  });
}
function get52WeekLow() {
  return API.get52WeekLow().then(function (value) {
    var data = value.data;
    console.log(data);
  });
}
...
function getTopValueStocks() {
  return API.getTopValueStocks().then(function (value) {
    var data = value.data;
    console.log(data);
  });
}
...
function getTopVolumeStocks() {
  return API.getTopVolumeStocks().then(function (value) {
    var data = value.data;
    console.log(data);
  });
}
...
function getChartDataNew(symbol, date) {
  return API.getChartDataNew(symbol, date).then(function (value) {
    var data = value.data;
    console.log(data);
  });
}

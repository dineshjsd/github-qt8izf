...
function getStockFuturesData(symbol, expiryDate, isIndex) {
  ...
  return axios({
    ...
    headers: {
      ...
      Host: 'www1.nseindia.com',
      Referer:
        'https://www1.nseindia.com/live_market/dynaContent/live_watch/get_quote/GetQuoteFO.jsp?underlying=' +
        symbol +
        '&instrument=' +
        params['instrument'] +
        '&type=SELECT&strike=SELECT&expiry=' +
        expiryDate,
    },
  });
}
...
function get52WeekHigh() {
  return axios({
    ...
    headers: {
      ...
      Host: 'www1.nseindia.com',
      Referer:
        'https://www1.nseindia.com/products/content/equities/equities/eq_new_high_low.htm',
    },
  });
}
...
function getTopValueStocks() {
  return axios({
    ...
    headers: {
      ...
      Host: 'www1.nseindia.com',
      Referer:
        'https://www1.nseindia.com/live_market/dynaContent/live_analysis/most_active_securities.htm',
    },
  });
}
